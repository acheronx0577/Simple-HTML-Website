...
| 03 | [Formatting Text](docs/step-03-text.md) | Creating headings (`<h1>`-`<h6>`) and paragraphs (`<p>`). |
| 04 | [Structuring with Containers](docs/step-04-containers.md) | Using `<div>` blocks to organize your page sections. |
| 05 | [Adding Links & Images](docs/step-05-links-images.md) | Linking pages together (`<a>`) and embedding images (`<img>`). |
